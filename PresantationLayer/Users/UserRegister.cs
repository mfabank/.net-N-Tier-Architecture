...
namespace MFABooks.PresantationLayer.Users
{
    public partial class UserRegister : Form
    {
        ...
        private void ekle_btn_Click(object sender, EventArgs e)
        {
            ...
            users = _userBll.userRegister(textBox1.Text,username_textbox.Text,password_textbox.Text,firstname_textbox.Text,lastname_textbox.Text,Convert.ToInt32 (age_textbox.Text),Convert.ToString(gender_combobox.Text));
